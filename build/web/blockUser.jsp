                        ...
                        <form action="MainController" method="POST">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button type="submit" name="action" value="SearchUserBlock" class="btn btn-primary">Search</button>
                                </div>
                            </div> 
                        </form>
                    </div>
                    <div class="my-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <%
                                        ArrayList<UserDTO> userList = (ArrayList<UserDTO>) request.getAttribute("BLOCK_USER_LIST");
                                        if (userList != null) {
                                ...
                                <form action="MainController" method="POST" accept-charset="UTF-8">
                                    ...
                                    <td>
                                        <input type="hidden" name="userid" value="<%= user.getUserID()%>">
                                        <button type="submit" name="action" value="Unblock" class="btn btn-primary btn-sm" onclick=" return window.confirm('Do you want to unblock this person? ')">UnBlock</button>
                                    </td>
                                    <% } %>
                                    </tr>
                                </form>
