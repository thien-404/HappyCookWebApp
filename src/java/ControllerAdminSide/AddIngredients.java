...
public class AddIngredients extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try  {
            ...
            IngredientDTO  ingredient = new IngredientDTO(name, price, 1, unit, role);
            
            boolean rs = d.insertIngredient(ingredient);
            if(rs){
                request.setAttribute("success", "Add Ingredient success");
            }else{
                request.setAttribute("message", "Add Ingredient fails");
            }
        }catch(Exception e){
            e.printStackTrace();
        }finally{
