 ...
 * @author HP
 */
public class IngredientCartControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(Ingrecart != null){
                ...
                for(IngredientMeal i : Ingrecart.keySet()){
            ...
            log("ERROR AT CartControllerServlet" + e.toString());
        }
    }
