                            ...
                            <table class="table table-bordered table-striped">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th scope="col" style="width: 8%;">Type Of Food</th>
                                ...
                                <tbody>
                                    <%
                                        ArrayList<MealDTO> mealList = (ArrayList<MealDTO>) request.getAttribute("DeletedMealList");
                                        if (mealList != null) {
                                ...
                                <form action="MainController" method="POST" enctype="multipart/form-data">
                                    ...
                                    <td><input type="number" name="typeOfFood" value="<%= meal.getTypeOfFood()%>" style="width: 100%;"></td>
                                    <td>
                                        <img id="preview" src="images/<%= meal.getImageUrl()%>" alt="<%= meal.getMealName()%>" class="img-thumbnail" width="100">
                                    </td>
                                    <td>
                                        <button type="submit" name="action" value="RestoreMeal" class="btn btn-primary btn-sm">Restore</button>                                    </td>
                                    </tr>
                                </form>
                                <%
                                        }
