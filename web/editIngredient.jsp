                    ...
                    <div class="my-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <%
                                        ArrayList<IngredientDTO> list = (ArrayList<IngredientDTO>) request.getAttribute("IngredientList");
                                        if (list != null) {
                                            for (IngredientDTO ingredient : list) {
                                    %>
                                <form action="MainController" method="POST" accept-charset="UTF-8">
                                    <tr>
                                        ...
                                        <td>
                                            <button type="submit" name="action" value="UpdateInredient" class="btn btn-primary btn-sm">Update</button>
                                            <button type="submit" name="action" value="DeleteInredient" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this meal?')">Delete</button>  
                                        </td>
                                    </tr>
                                </form>
                                <%
